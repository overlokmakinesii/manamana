...
public:
    ...
    float get_waypoint_bearing();
    void set_angle_target_to_waypoint_edited(uint8_t instance, float roll_deg, float pitch_deg, float yaw_deg, bool yaw_is_earth_frame);
;
