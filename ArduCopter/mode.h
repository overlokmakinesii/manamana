...
public:
    ...
    enum class Number : uint8_t {
        ...
        NOZZLE_POINTING = 29, // Nozzle pointing mode
...
class ModeNozzlePointing : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return auto_RTL? Number::AUTO_RTL : Number::NOZZLE_POINTING; }
    ...
    // AP_Mission mission{
    //     FUNCTOR_BIND_MEMBER(&ModeNozzlePointing::start_command, bool, const AP_Mission::Mission_Command &),
    //     FUNCTOR_BIND_MEMBER(&ModeNozzlePointing::verify_command, bool, const AP_Mission::Mission_Command &),
    //     FUNCTOR_BIND_MEMBER(&ModeNozzlePointing::exit_mission, void)};
...
protected:
    ...
    const char *name() const override { return auto_RTL? "AUTO RTL" : "NOZZLE_POINTING"; }
    const char *name4() const override { return auto_RTL? "ARTL" : "NOZZLE_POINTING"; }
